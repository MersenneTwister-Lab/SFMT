...
static unsigned int POS1 = 122;
static unsigned int SL1 = 18;
static unsigned int SL2 = 1;
static unsigned int SR1 = 11;
static unsigned int SR2 = 1;
static uint32_t MSK1 = 0xdfffffefUL;
static uint32_t MSK2 = 0xddfecb7fUL;
static uint32_t MSK3 = 0xbffaffffUL;
static uint32_t MSK4 = 0xbffffff6UL;
