...
#define SL1 2
#define SR1 7
#define MSK1 0x75c43b4fUL
#define MSK2 0xb47d5030UL
#define MSK3 0x244d9e76UL
#define MSK4 0xd7fd6406UL
...
INLINE static vector unsigned int vec_recursion(vector unsigned int a,
    ...
    return vec_xor(vec_xor(vec_xor(vec_sl(a, sl), a),
			   vec_xor(vec_and(b, mask), vec_perm(b, b, perm))),
