...
\end{equation}
is surjective for all $i=0,1,2,3$. 
...
By the choice of $s_r=0$, we have $U=\{0\}$, and
...
proposition implies that $k'(v)$ concides 
...
somewhere else,
because of the lack of the space.
...
Pentium 4 & block & 0.633  & 0.391  & 0.412  & 0.217 \\ \cline{3-6}
...
and the dimension defects MT19937 for $v=1,2,\ldots, 32$.
...
terms is increased, 
the necessary sample size is increased exponentially. Thus, it seems
