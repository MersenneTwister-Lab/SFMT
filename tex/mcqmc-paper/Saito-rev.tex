...
$32-r$ Most Significant Bits (MSBs) of $\bw_0$ and $r$ Least Significant Bits (LSBs) of $\bw_1$,
...
and $V_r:=\ker \left(\phi_r(f)\right)$, here $\ker$ means the kernel, 
...
two most recently computed words 
