...
language, to convert 64-bit interger $x$ to double precision floating
point number $y$ is done by:
\begin{verbatim}
...
The double precision floating point number defined by the standard
\includegraphics[width=0.7\linewidth]{ieee.pdf}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{SIMD-oriented Fast Mersenne Twister}
\label{sec:jump}
